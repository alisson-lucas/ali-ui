export default function Hero8() {
    return (
        <div className="flex items-center justify-center relative w-full  px-6 pt-14 pb-8 lg:px-8  bg-[url('https://fastly.picsum.photos/id/1/5000/3333.jpg?hmac=Asv2DU3rA_5D1xSe22xZK47WEAN0wjWeFOhzd13ujW4')] bg-cover bg-center bg-no-repeat after:content[''] after:absolute after:bg-gradient-to-t after:from-black after:to-transparent after:top-0 after:bottom-0 after:right-0 after:left-0 after:z-20">
            <div className="flex flex-col lg:flex-row items-end justify-center w-full lg:min-h-[600px] container py-28 pb-0 z-30">
