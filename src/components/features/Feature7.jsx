    ...
    return (
        <div className="flex items-center justify-center w-full bg-white">
            <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between w-full gap-8 container py-10 lg:py-20 px-8 lg:px-14">
                <div className="flex flex-col items-start justify-center w-full gap-14 py-4 lg:px-10">
                    <div className="flex flex-wrap items-center justify-center w-full gap-14 py-4 lg:px-10">
                        <article className="flex flex-col items-center justify-center gap-4 py-4 w-[calc(100%/2-30px)] lg:w-[calc(100%/4-50px)]">
                            <span className="font-bold text-3xl text-center lg:text-4xl text-black">80%</span>
                    ...
                    <div className="flex items-center justify-center w-full gap-x-8 lg:px-10">
                        <a
                            href="" target="_blank"
