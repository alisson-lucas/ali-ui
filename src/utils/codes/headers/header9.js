...
export default function Header9() {
    ...
    return (
        <header className="relative inset-x-0 top-0 z-50 mt-2">
            <div className='flex flex-row items-center justify-center w-full shadow-lg shadow-black/5'>
                <nav className="lg:max-w-screen-xl 2xl:max-w-screen-2xl bg-white rounded-full flex items-center justify-between p-4 lg:px-8 w-full z-50 relative" aria-label="Global">
                    ...
                    <div className="hidden lg:flex lg:flex-1 lg:justify-end gap-4 ">
                        <a href="" className='bg-primary text-white text-sm px-6 py-1 rounded-lg font-semibold'>Inscreva-se</a>
