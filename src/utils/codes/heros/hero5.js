export const hero5 = `
<div className="flex items-center justify-center relative w-full  px-6 py-14 2xl:py-28 lg:px-8 bg-[url('/images/background3.png')] bg-cover bg-center bg-no-repeat">
